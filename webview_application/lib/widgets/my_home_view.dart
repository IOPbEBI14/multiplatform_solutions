...
import '../data/what_ta_fck.dart'
    if (dart.library.io) 'package:webview_application/data/non_web_platform_webview.dart'
    if (dart.library.html) 'package:webview_application/data/web_platform_webview.dart'
    as multiplatform;
